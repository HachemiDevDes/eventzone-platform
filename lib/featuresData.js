...
export const ALL_FEATURES = [
  ...
  {
    slug: "facturation-devis-proforma",
    aliases: ["facturation", "devis", "invoicing", "quotes", "invoicing-quotes", "factures-devis", "billing"],
    moduleNumber: "13",
    category: "Gestion Financière & Conformité",
    title: "Facturation, Devis & Proforma Conformes",
    tagline: "Command center de facturation certifiée, devis commerciaux, factures proforma et suivi des encaissements.",
    badge: "Module 13 • Finance & Facturation Légale",
    heroDescription: "Pilotez toute la chaîne financière de vos événements : éditez des devis et factures proforma en quelques clics, générez des factures officielles conformes à la réglementation fiscale (NIF, NIS, RC, TVA, arrêté en toutes lettres), et suivez vos encaissements et trésorerie en temps réel.",
    keyMetrics: [
      { value: "100%", label: "Conformité Fiscale DZ" },
      { value: "< 60s", label: "Génération Facture A4" },
      { value: "0 Erreur", label: "Arrêté en Toutes Lettres" },
      { value: "Multi-Devise", label: "DZD, EUR, USD" }
    ],
    valuePillars: [
      {
        icon: "ShieldCheck",
        title: "Conformité Fiscale & Mentions Légales",
        description: "Intégration native des identifiants fiscaux officiels (NIF, NIS, RC, Article d'imposition), TVA 19% paramétrable et conversion automatique du montant en toutes lettres."
      },
      {
        icon: "FileCheck",
        title: "Cycle Commercial : Devis, Proforma & Factures",
        description: "Transformez vos devis acceptés en factures proforma puis en factures définitives en 1 clic sans ressaisie, avec numérotation chronologique continue."
      },
      {
        icon: "BarChart3",
        title: "Suivi de Trésorerie & Encaissements en Direct",
        description: "Tableau de bord financier pour suivre le total encaissé, les règlements en attente, les factures en retard et le taux de recouvrement global de vos événements."
      }
    ],
    deepDiveFeatures: [
      {
        title: "Command Center & Registre Officiel des Documents",
        subtitle: "Centralisation de toutes vos transactions commerciales et comptables",
        description: "Retrouvez l'ensemble de vos factures, devis et factures proforma dans un registre unifié. Filtrez instantanément par client, statut de règlement ou date d'échéance et exportez vos données en CSV pour votre expert-comptable.",
        checklist: [
          "Tableau de bord synthétique (Total encaissé, En attente, En retard, Taux d'encaissement)",
          "Filtres avancés par type de document, profil d'émetteur et statut d'encaissement",
          "Export CSV comptable et actions rapides (duplication, téléchargement PDF, archivage)"
        ],
        visualType: "invoicing-register-preview"
      },
      {
        title: "Profils de Facturation & Identifiants Fiscaux DZ",
        subtitle: "Paramétrage juridique complet pour entreprises et organisateurs",
        description: "Facturez au nom de plusieurs entités grâce au multi-profil. Configurez votre raison sociale, adresse légale, numéro de téléphone, NIF, NIS, RC, Article d'imposition, logo et cachet/signature numérisé.",
        checklist: [
          "Prise en charge intégrale des mentions fiscales algériennes (NIF, NIS, RC, AI)",
          "Intégration du logo d'entreprise et du cachet humide / signature électronique",
          "Gestion multi-devises (Dinar Algérien DZD, Euro, Dollar) et coordonnées bancaires RIB"
        ],
        visualType: "fiscal-profile-preview"
      },
      {
        title: "Éditeur Visuel Double Écran & Aperçu A4 en Direct",
        subtitle: "Concevez des documents irréprochables sans calculs manuels",
        description: "Renseignez les prestations et quantités dans le volet de configuration tout en visualisant le document A4 officiel se composer en temps réel à l'écran, avec calcul instantané de la TVA et de l'arrêté en toutes lettres.",
        checklist: [
          "Aperçu A4 interactif en temps réel conforme aux formats administratifs",
          "Calcul automatique du sous-total HT, TVA (19%) et du total TTC",
          "Arrêté officiel de la somme en toutes lettres généré automatiquement par l'algorithme"
        ],
        visualType: "invoice-editor-split-preview"
      },
      {
        title: "Export PDF Haute Définition & Partage Sécurisé",
        subtitle: "Documents prêts à imprimer ou à envoyer à vos clients et sponsors",
        description: "Générez des factures PDF vectorielles légères et professionnelles en un clic. Imprimez directement sur vos imprimantes de bureau ou transmettez un lien de consultation sécurisé à vos clients B2B.",
        checklist: [
          "Téléchargement PDF vectoriel A4 ultra-net avec charte graphique officielle",
          "Bouton d'impression directe optimisé pour navigateurs et imprimantes",
          "Lien de partage client sécurisé avec mise à jour automatique des statuts"
        ],
        visualType: "pdf-export-preview"
      }
    ],
    comparison: {
      traditional: [
        "Facturation manuelle sur Excel ou Word avec erreurs récurrentes de TVA et d'arrondis",
        "Documents sans cachet ni mentions fiscales obligatoires (NIF/RC) rejetés par la comptabilité",
        "Saisie manuelle fastidieuse du montant en toutes lettres et devis perdus sans suivi",
        "Aucune visibilité sur les impayés, les dates d'échéance et le solde de trésorerie"
      ],
      eventzone: [
        "Éditeur automatique avec calculs HT / TVA 19% / TTC et montant en toutes lettres infaillible",
        "Conformité fiscale DZ intégrale (NIF, NIS, RC, AI) avec cachet et signature intégrés",
        "Transformation d'un devis en proforma puis en facture définitive en 1 clic",
        "Tableau de bord financier en temps réel avec suivi des encaissements et alertes de retard"
      ]
    },
    faq: [
      {
        q: "Le module de facturation Eventzone est-il conforme aux lois fiscales algériennes ?",
        a: "Oui, le module respecte scrupuleusement la réglementation commerciale et fiscale algérienne. Il intègre le NIF, le NIS, le Registre de Commerce (RC), l'Article d'Imposition (AI), le taux de TVA standard à 19% et la mention légale obligatoire de l'arrêté de la somme en toutes lettres."
      },
      {
        q: "Peut-on transformer un devis accepté en facture sans devoir tout ressaisir ?",
        a: "Absolument. En un seul clic depuis votre registre ou depuis l'éditeur, vous pouvez convertir un devis en facture proforma ou en facture définitive. Tous les articles, quantités, prix et coordonnées du client sont automatiquement transférés."
      },
      {
        q: "Comment fonctionne la génération de l'arrêté de la somme en toutes lettres ?",
        a: "Eventzone intègre un moteur algorithmique de conversion textuelle certifié (disponible en français et arabe). Dès que vous modifiez un prix ou une quantité, le texte officiel (« Arrêté à la somme de... ») se met à jour instantanément sans risque d'erreur humaine."
      },
      {
        q: "Puis-je gérer plusieurs entreprises ou filiales sur le même compte Eventzone ?",
        a: "Oui, la fonctionnalité multi-profils vous permet de configurer plusieurs entités émettrices distinctes (par exemple une agence événementielle et une société de production technique), chacune avec son propre logo, ses identifiants fiscaux, ses coordonnées bancaires et son cachet."
      },
      {
        q: "Les factures peuvent-elles être émises en devises étrangères ?",
        a: "Oui, vous pouvez créer et éditer des documents en Dinar Algérien (DZD), en Euro (EUR) ou en Dollar Américain (USD), avec conversion automatique et affichage des devises adéquates sur le PDF final."
      }
    ]
  }
];
