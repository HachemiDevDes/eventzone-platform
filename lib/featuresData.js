...
export const ALL_FEATURES = [
  ...
  {
    slug: "video-test",
    aliases: ["test-video", "video", "design-test"],
    moduleNumber: "Test",
    category: "Design Lab & Vidéo Immersive",
    title: "Video Test",
    heroVideo: "/website-bg-video.mp4",
    tagline: "Laboratoire de design interactif avec arrière-plan vidéo cinématique pour Eventzone.",
    badge: "Module Test • Design Lab & Vidéo",
    heroDescription: "Environnement expérimental pour tester le rendu vidéo en arrière-plan, l'ergonomie visuelle, les contrastes glassmorphism et les nouvelles interfaces événementielles.",
    keyMetrics: [
      { value: "4K / 60fps", label: "Fluidité Vidéo" },
      { value: "< 1.0s", label: "Temps d'affichage" },
      { value: "100%", label: "Mobile Responsive" },
      { value: "Design Lab", label: "Prototype Actif" }
    ],
    valuePillars: [
      {
        icon: "Video",
        title: "Atmosphère Visuelle Immersive",
        description: "Arrière-plan vidéo dynamique pour captiver les visiteurs et valoriser l'ambiance des événements dès la première seconde."
      },
      {
        icon: "Sparkles",
        title: "Glassmorphism & Typographie Nette",
        description: "Surfaces translucides et contrastes étudiés pour préserver une lisibilité absolue des textes et boutons d'action."
      },
      {
        icon: "Layers",
        title: "Performance & Optimisation Web",
        description: "Lecture vidéo native sans saccade, respectueuse du CPU et parfaitement adaptée aux smartphones et écrans larges."
      }
    ],
    deepDiveFeatures: [
      {
        title: "Intégration Vidéo Hero Plein Format",
        subtitle: "Un impact visuel cinématographique immédiat",
        description: "L'arrière-plan vidéo plein format donne vie à votre événement tout en conservant une fluidité et une réactivité exemplaires.",
        checklist: [
          "Lecture automatique en boucle silencieuse",
          "Optimisation matérielle GPU pour fluidité maximale",
          "Filtre de contraste pour garantir la lisibilité du texte"
        ],
        visualType: "video-hero-preview"
      },
      {
        title: "Composants Aériens & Effet Verre Dépoli",
        subtitle: "Élégance visuelle et lisibilité maximale",
        description: "Les blocs de contenu s'intègrent harmonieusement sur la vidéo grâce à des superpositions calibrées et des bordures subtiles.",
        checklist: [
          "Cartes en verre dépoli avec bordures subtiles",
          "Ombres douces et lissages de coins squircle",
          "Micro-interactions fluides au survol"
        ],
        visualType: "glassmorphic-cards"
      },
      {
        title: "Optimisation Bande Passante & Batterie",
        subtitle: "Une expérience fluide même sur réseaux mobiles",
        description: "Le chargement de la vidéo est optimisé pour ne jamais ralentir le premier affichage ni bloquer les scripts de navigation.",
        checklist: [
          "Préchargement progressif optimisé",
          "Zéro blocage du thread principal",
          "Accessibilité et respect des préférences utilisateur"
        ],
        visualType: "performance-metrics"
      },
      {
        title: "Personnalisation & Scénarisation Graphique",
        subtitle: "Une identité visuelle marquante pour chaque événement",
        description: "Adaptez la vidéo, les filtres chromatiques et les textes en fonction de la thématique ou de l'organisateur.",
        checklist: [
          "Remplacement instantané du fichier vidéo",
          "Ajustement du degré de flou et d'opacité",
          "Harmonisation automatique avec la charte Eventzone"
        ],
        visualType: "design-customizer"
      }
    ],
    comparison: {
      traditional: [
        "Bannières statiques plates manquant d'émotion et d'impact visuel",
        "Vidéos lourdes bloquant le chargement de la page et consommant de la batterie",
        "Textes illisibles superposés sans filtres de contraste adéquats"
      ],
      eventzone: [
        "Arrière-plan vidéo cinématique captivant avec filtres adaptatifs",
        "Performances de chargement ultra-rapides et fluidité 60 fps",
        "Lisibilité parfaite du texte et des boutons d'action en toute circonstance"
      ]
    },
    faq: [
      {
        q: "Quel est l'objectif de cette page 'Video Test' ?",
        a: "Cette page sert de laboratoire de design pour expérimenter de nouveaux composants visuels, tester l'arrière-plan vidéo cinématique et valider la nouvelle direction artistique d'Eventzone."
      },
      {
        q: "La vidéo d'arrière-plan fonctionne-t-elle sur smartphone ?",
        a: "Oui, la vidéo utilise les attributs playsInline et muted pour une lecture automatique fluide sur iOS et Android sans basculer en plein écran natif."
      },
      {
        q: "La vidéo affecte-t-elle la lisibilité des textes ?",
        a: "Non, un calque translucide calibré et un dégradé doux garantissent un contraste optimal pour que les textes et boutons restent parfaitement lisibles."
      }
    ]
  }
];
