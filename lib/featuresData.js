...
import { FEATURES_UI_I18N, MODULES_TRANSLATIONS } from "./featuresI18n";
...
export const ALL_FEATURES = [
  ...
  {
    slug: "multi-gate-check-in",
    aliases: ["multi-gate-checkin", "controle-acces-securite", "controle-acces", "securite-flux", "multi-portes"],
    moduleNumber: "07",
    category: "Opérations Jour-J & Multi-Portes",
    title: "Multi-Gate Check-in & Contrôle d'Accès",
    tagline: "Attribution des flux par porte, passcodes dédiés par équipe d'accueil et jauges en temps réel.",
    badge: "Module 07 • Multi-Gate Check-in & Sécurité",
    heroDescription: "Déployez un dispositif d'accueil multi-portes haute cadence. Attribuez un code de connexion à 6 caractères par porte (Porte Nord, Porte Sud, Accès VIP, Presse), suivez l'affluence en direct et empêchez les fraudes et goulets d'étranglement.",
    keyMetrics: [
      { value: "Multi-Portes", label: "Gestion simultanée" },
      { value: "6 Chiffres", label: "Passcode par porte" },
      { value: "0 Doublon", label: "Anti-fraude multi-accès" },
      { value: "In & Out", label: "Comptage en direct" }
    ],
    valuePillars: [
      {
        icon: "ShieldCheck",
        title: "Passcodes & Portes Dédiées",
        description: "Créez des accès séparés avec codes d'activation uniques pour affecter les contrôleurs à leur point d'entrée spécifique."
      },
      {
        icon: "Activity",
        title: "Attribution des Entrées par Porte",
        description: "Traçabilité complète de chaque passage permettant de savoir précisément par quelle porte chaque visiteur a été émargé."
      },
      {
        icon: "Sliders",
        title: "Jauges de Salles & Décompte In/Out",
        description: "Compteur dynamique des présences sur site et alertes instantanées avant saturation des espaces."
      }
    ],
    deepDiveFeatures: [
      {
        title: "Configuration Multi-Portes & Passcodes Dédiés",
        subtitle: "Sécurité et autonomie pour chaque équipe d'accueil",
        description: "Créez en quelques clics des portes indépendantes (Porte Principale, Porte VIP, Accès Exposants, Régie). Chaque porte dispose de son propre code d'accès à 6 caractères pour sécuriser la connexion des agents.",
        checklist: [
          "Création illimitée de portes et points de passage",
          "Passcode unique à 6 caractères par équipe de porte",
          "Connexion mobile instantanée sur ci.eventzone.pro"
        ],
        visualType: "gate-passcodes"
      },
      {
        title: "Attribution des Entrées & Traçabilité par Porte",
        subtitle: "Sachez exactement où et par qui chaque participant est entré",
        description: "Chaque badge scanné est automatiquement associé à sa porte d'enregistrement. Vous identifiez en direct les portes les plus sollicitées et réaffectez votre personnel sans attendre.",
        checklist: [
          "Attribution automatique du badge à sa porte d'accueil",
          "Statistiques d'entrées ventilées par porte en temps réel",
          "Détection immédiate des tentatives de scan sur la mauvaise porte"
        ],
        visualType: "zone-permissions"
      },
      {
        title: "Gestion des Jauges & Décompte In/Out",
        subtitle: "Surveillance de la capacité maximale en direct",
        description: "Suivez le taux d'occupation de chaque halle ou amphithéâtre en direct. Le système décompte les sorties pour maintenir un compte exact des personnes présentes dans chaque zone.",
        checklist: [
          "Compteur dynamique des présents sur site en direct",
          "Alerte de saturation automatique avant d'atteindre la jauge maximale",
          "Mode entrée / sortie commutable en un tap"
        ],
        visualType: "capacity-gauge"
      },
      {
        title: "Tableau de Bord des Flux Multi-Portes & Audit",
        subtitle: "Vision globale et synchronisation instantanée",
        description: "Supervisez l'ensemble des accès depuis une console centrale. Suivez la cadence des passages, l'activité de chaque contrôleur et exportez l'historique complet pour vos bilans de sécurité.",
        checklist: [
          "Flux de passages synchronisé en direct entre toutes les portes",
          "Journal d'audit horodaté avec identifiant du contrôleur et de la porte",
          "Export certifié des feuilles d'émargement multi-portes en Excel et PDF"
        ],
    ...
    comparison: {
      traditional: [
        "Contrôleurs désynchronisés partageant un même compte sans distinction des portes",
        "Incapacité à savoir quelle porte est engorgée pour réorienter la foule",
        "Risques d'utilisation répétée du même badge sur deux portes différentes"
      ],
      eventzone: [
        "Passcodes 6 caractères dédiés par porte avec interface mobile instantanée",
        "Statistiques d'affluence par porte actualisées en temps réel",
        "Synchronisation instantanée empêchant formellement les doubles entrées"
      ]
    },
    faq: [
      {
        q: "Comment les agents de sécurité se connectent-ils à leur porte ?",
        a: "Chaque agent saisit le mot de passe à 6 caractères de sa porte (ex. 8X9K2P) sur ci.eventzone.pro. Son smartphone se configure instantanément pour cette porte sans installation d'application."
      },
      {
        q: "Peut-on suivre les entrées porte par porte en temps réel ?",
        a: "Oui, le tableau de bord organisateur affiche les compteurs d'entrées ventilés par porte en direct (Porte Nord, Porte Sud, VIP, etc.)."
      },
      {
        q: "Un participant peut-il utiliser son pass deux fois sur deux portes différentes ?",
        a: "Non, dès le scan à la première porte, le badge est marqué comme utilisé en temps réel sur l'ensemble du réseau, bloquant immédiatement toute tentative sur une autre porte."
      }
    ]
  },
  ...
  // Module 12: Portail Participant & Espace Visiteur Interactif
  {
    slug: "portail-participant",
    aliases: ["attendee-portal", "visitor-portal", "portail-visiteur", "espace-participant"],
    moduleNumber: "12",
    category: "Expérience Participant & Espace Connecté",
    title: "Portail Participant & Espace Visiteur Interactif",
    tagline: "Espace web tout-en-un sans téléchargement d'appli : badge QR numérique, agenda personnel, networking et plan interactif.",
    badge: "Module 12 • Expérience & Portail Participant",
    heroDescription: "Offrez à chaque participant un compagnon web interactif accessible instantanément sur mobile sans installation d'application lourde. Retrouvez en un clic le badge d'accès avec QR code sécurisé, un agenda sur-mesure synchronisé, un répertoire de networking direct avec les autres participants et la cartographie des stands en temps réel.",
    keyMetrics: [
      { value: "0 App", label: "Accès Web Instantané" },
      { value: "100%", label: "Mobile Responsive" },
      { value: "< 2s", label: "Chargement du Badge" },
      { value: "Live Sync", label: "Agenda & Annonces" }
    ],
    valuePillars: [
      {
        icon: "Smartphone",
        title: "Accès Web Universel Sans Téléchargement",
        description: "Fini les barrières d'installation sur l'App Store ou Google Play. Un simple lien web sécurisé ou QR code ouvre immédiatement l'espace complet du participant sur smartphone."
      },
      {
        icon: "Ticket",
        title: "Badge Numérique, Passcode & Impression A4",
        description: "Badge d'accès haute sécurité avec QR code toujours à portée de main sur mobile, passcodes d'accès rapides et option d'impression du badge A4 officiel en un clic."
      },
      {
        icon: "Compass",
        title: "Agenda Personnalisé, Networking & Plan de Salle",
        description: "Sélection des conférences favorites avec rappels, annuaire des participants avec demandes de mise en relation et guidage interactif entre les stands."
      }
    ],
    deepDiveFeatures: [
      {
        title: "Badge Numérique Sécurisé & Portefeuille d'Accès Mobile",
        subtitle: "Votre pass d'entrée toujours disponible sans risquer d'égarer votre billet papier",
        description: "Chaque visiteur retrouve sa carte d'accès avec QR code dynamique haute résolution, nom complet, entreprise, statut VIP ou Standard, et catégorie de pass.",
        checklist: [
          "QR code vectoriel net même en faible luminosité ou écran fissuré",
          "Affichage de la porte assignée et du badge de statut VIP",
          "Téléchargement du badge au format PDF A4 officiel en un clic"
        ],
        visualType: "portal-badge-wallet"
      },
      {
        title: "Mon Agenda Personnel & Favoris de Sessions",
        subtitle: "Planifiez votre parcours parmi des dizaines de conférences et ateliers en parallèle",
        description: "Les participants consultent le programme complet par salle ou piste thématique, ajoutent leurs sessions favorites à leur planning personnel et activent les rappels.",
        checklist: [
          "Filtres par jour, salle, intervenant et track thématique",
          "Mise en favoris d'un clic pour composer son agenda sur-mesure",
          "Exportation et synchronisation directe vers Google Calendar et Apple Calendar"
        ],
        visualType: "portal-my-agenda"
      },
      {
        title: "Annuaire des Participants & Mise en Relation Directe",
        subtitle: "Décuplez les opportunités de partenariats et d'affaires entre professionnels",
        description: "Consultez les profils professionnels des participants enregistrés, filtrez par secteur d'activité ou entreprise et initiez des demandes de contact qualifiées.",
        checklist: [
          "Profils professionnels avec photo, fonction, entreprise et centres d'intérêt",
          "Envoi de demandes de connexion et échanges dans un cadre sécurisé",
          "Contrôle total de la vie privée par chaque participant (mode visible ou discret)"
        ],
        visualType: "portal-attendee-networking"
      },
      {
        title: "Plan Vectoriel Intégré & Répertoire des Exposants",
        subtitle: "Orientation instantanée vers les stands, sponsors et espaces de networking",
        description: "Le plan vectoriel 2D est directement consultable dans le portail. Les visiteurs localisent immédiatement l'emplacement exact d'un exposant ou d'une salle.",
        checklist: [
          "Navigation tactile avec zoom haute définition sur les allées et stands",
          "Fiches détaillées des exposants avec catalogues et contacts",
          "Localisation rapide des commodités (accueil, restauration, vestiaires)"
        ],
    ...
    comparison: {
      traditional: [
        "Obligation de faire télécharger une application mobile lourde (50+ Mo) souvent refusée par les participants",
        "Billets papier égarés ou PDF enfouis dans les boîtes mail causant de longues files d'attente à l'entrée",
        "Programmes papier obsolètes dès qu'une salle ou un horaire de conférence est modifié en dernière minute"
      ],
      eventzone: [
        "Accès web instantané en 1 clic sans aucun téléchargement ni création de compte préalable obligatoire",
        "Badge QR toujours disponible, affichage de la porte d'entrée assignée et impression A4 prête",
        "Agenda dynamique mis à jour en temps réel avec notifications, favoris et synchronisation calendrier"
      ]
    },
    faq: [
      {
        q: "Les participants doivent-ils installer une application depuis l'App Store ou Google Play ?",
        a: "Non, absolument aucun téléchargement n'est requis. Le Portail Participant Eventzone est une Progressive Web App (PWA) ultra-légère accessible directement via n'importe quel navigateur mobile."
      },
      {
        q: "Comment les participants accèdent-ils à leur espace personnalisé ?",
        a: "Ils reçoivent un lien magique sécurisé par email ou SMS lors de leur inscription, ou scannent simplement leur QR code de confirmation pour ouvrir leur portail pré-rempli."
      },
      {
        q: "L'organisateur peut-il activer ou masquer certains onglets (ex: networking ou chat) ?",
        a: "Oui, depuis le tableau de bord organisateur, vous pouvez activer, désactiver ou réordonner en direct les onglets du portail selon les besoins spécifiques de votre manifestation."
      }
    ]
  },
  ...
  {
    slug: "video-test",
    aliases: ["test-video", "video", "design-test", "marketing-conversion", "social-conversion"],
    moduleNumber: "Marketing",
    category: "Marketing & Conversion Social Media",
    title: "Conversion Social Media & Marketing Événementiel",
    heroVideo: "/website-bg-video.mp4",
    tagline: "Transformez vos abonnés Instagram, TikTok et LinkedIn en participants confirmés et clients payants.",
    badge: "Moteur de Conversion Social Media",
    heroDescription: "Ne perdez plus 80% de votre audience mobile. Eventzone optimise vos tunnels de billetterie pour les navigateurs intégrés aux réseaux sociaux avec un checkout en 1 clic et une relance WhatsApp automatisée.",
    keyMetrics: [
      { value: "+340%", label: "Taux de Conversion" },
      { value: "< 0.8s", label: "Chargement In-App" },
      { value: "94%", label: "Ouverture WhatsApp" },
      { value: "1-Clic", label: "Checkout Sans Friction" }
    ],
    valuePillars: [
      {
        icon: "Smartphone",
        title: "Tunnels Spéciaux Navigateurs In-App",
        description: "Conçu sur-mesure pour les webviews Instagram, TikTok et LinkedIn. Zéro redirection lente, panier en 1 étape et paiement mobile instantané sans création de compte obligatoire."
      },
      {
        icon: "MessageSquare",
        title: "Relance Automatisée WhatsApp & SMS",
        description: "Récupérez jusqu'à 45% des paniers abandonnés grâce à des notifications WhatsApp personnalisées avec un taux d'ouverture de 94% et livraison instantanée des billets QR."
      },
      {
        icon: "TrendingUp",
        title: "Tracking Multi-Pixel & Liens Affiliés",
        description: "Attribuez chaque vente à la bonne campagne, story ou influenceur. Intégration directe Meta CAPI, TikTok Pixel, GA4 et tableau de bord de commission pour vos ambassadeurs."
      }
    ],
    deepDiveFeatures: [
      {
        title: "Tunnel Mobile In-App Browser Ultra-Rapide",
        subtitle: "Convertissez les scroll-stoppers en acheteurs en moins de 30 secondes",
        description: "Les pages événementielles lentes perdent plus de 70% de leurs visiteurs mobiles dès les premières secondes. Eventzone charge en moins de 0.8s directement dans le navigateur intégré d'Instagram ou TikTok, avec un paiement express sans mot de passe.",
        checklist: [
          "Poids plume inférieur à 120 Ko pour un affichage instantané en 4G/5G",
          "Inscription invité en 1 clic sans forcer la création d'un compte",
          "Remplissage automatique et intégration directe des paiements mobiles (CIB, Edahabia, Carte)"
        ],
        visualType: "social-funnel-preview"
      },
      {
        title: "Relance WhatsApp Automatique des Paniers Abandonnés",
        subtitle: "Réengagez vos prospects chauds avec 94% de taux d'ouverture",
        description: "L'e-mail traditionnel plafonne à 15% d'ouverture sur le trafic social. Eventzone envoie un message WhatsApp interactif 15 minutes après un abandon de panier pour lever les hésitations et finaliser l'inscription avec un lien direct.",
        checklist: [
          "Relance automatique déclenchée dès qu'un numéro est renseigné",
          "Boutons interactifs d'action directe : 'Finaliser ma place', 'Contacter l'organisateur'",
          "Envoi immédiat du pass digital avec QR code directement dans la discussion WhatsApp"
        ],
        visualType: "whatsapp-recovery-preview"
      },
      {
        title: "Programme Ambassadeurs & Attribution Créateurs",
        subtitle: "Mobilisez vos intervenants, sponsors et créateurs de contenu",
        description: "Générez en 1 clic des liens affiliés uniques pour chacun de vos conférenciers, partenaires et influenceurs. Suivez en temps réel les clics, les billets vendus et le chiffre d'affaires généré par chaque créateur.",
        checklist: [
          "Liens de tracking personnalisés avec codes promo automatiques",
          "Tableau de bord transparent des ventes et calcul automatique des commissions",
          "Kits visuels personnalisés prêts à partager en Story Instagram et sur LinkedIn"
        ],
        visualType: "influencer-attribution-preview"
      },
      {
        title: "Tracking Multi-Pixel & Mesure Précise du ROAS",
        subtitle: "Fini les angles morts : mesurez l'impact réel de vos publicités sociales",
        description: "Les restrictions iOS bloquent une grande partie des cookies tiers. Eventzone intègre la nouvelle API Conversions Meta (CAPI) côté serveur et le Pixel TikTok pour remonter 100% des achats et optimiser le coût par acquisition de vos campagnes.",
        checklist: [
          "Double tracking navigateur et serveur Meta CAPI pour une attribution infaillible",
          "Suivi granulaire par campagne, ensemble de publicités et créative visuelle",
          "Rapports marketing exportables et synchronisation Google Analytics 4"
        ],
        visualType: "conversion-analytics-preview"
      }
    ],
    comparison: {
      traditional: [
        "Pages web lourdes conçues pour PC qui mettent plus de 4 secondes à s'afficher dans Instagram ou TikTok",
        "Formulaires à rallonge et création de compte obligatoire causant 82% d'abandon sur mobile",
        "Relances uniquement par e-mail avec un taux d'ouverture moyen de seulement 12 à 18%",
        "Aucune visibilité sur la rentabilité réelle des influenceurs, partenaires ou publicités sponsorisées"
      ],
      eventzone: [
        "Tunnels mobiles ultra-véloces s'affichant en moins de 0.8s au cœur des navigateurs in-app",
        "Checkout sans friction en 1 clic avec inscription invité et paiement mobile fluide",
        "Relance WhatsApp automatisée affichant 94% d'ouverture et récupérant jusqu'à 45% des paniers",
        "Tracking multi-pixel server-side Meta CAPI et tableau de bord affilié complet par influenceur"
      ]
    },
    faq: [
      {
        q: "Comment Eventzone convertit-il mieux le trafic des réseaux sociaux ?",
        a: "Nos tunnels de réservation sont spécifiquement conçus pour les navigateurs in-app intégrés d'Instagram, TikTok et LinkedIn. Sans scripts superflus, ils s'affichent en moins de 0.8s et permettent à vos visiteurs d'acheter leur billet en deux étapes sans devoir créer de compte ni quitter l'application sociale."
      },
      {
        q: "Puis-je connecter mon Pixel Meta, TikTok et Google Tag Manager ?",
        a: "Absolument. Eventzone intègre le Pixel Meta et la nouvelle API Conversions (CAPI) côté serveur, le Pixel TikTok, Google Tag Manager et GA4. Vous disposez ainsi d'une attribution précise à 100% même face aux restrictions de suivi d'Apple iOS."
      },
      {
        q: "Comment fonctionne la relance automatique par WhatsApp ?",
        a: "Dès qu'un visiteur commence sa réservation mais ne va pas au bout, Eventzone déclenche une notification WhatsApp amicale et personnalisée 15 minutes plus tard. Le message contient un lien direct pour reprendre son panier en un clic, ce qui permet de récupérer en moyenne 35% à 45% des ventes abandonnées."
      },
      {
        q: "Nos intervenants et partenaires peuvent-ils suivre leurs propres ventes ?",
        a: "Oui. Vous pouvez générer un lien de suivi dédié pour chaque intervenant, sponsor ou influenceur partenaire. Ils bénéficient d'une interface claire affichant les visites, les réservations générées et leurs éventuelles commissions."
      },
      {
        q: "Cette solution convient-elle aussi bien aux événements B2B qu'aux festivals grand public ?",
        a: "Parfaitement. Que vous fassiez de la prospection LinkedIn pour un sommet B2B exclusif ou des campagnes TikTok virales pour un festival de plusieurs milliers de personnes, l'architecture Eventzone absorbe les pics massifs de trafic social sans aucun ralentissement."
      }
    ]
  }
];

export function getFeaturesUI(lang = "fr") {
  const activeLang = ["en", "fr", "ar"].includes(lang) ? lang : "fr";
  return FEATURES_UI_I18N[activeLang] || FEATURES_UI_I18N.fr;
}

export function getLocalizedFeature(feature, lang = "fr") {
  ...
  const langOverrides = MODULES_TRANSLATIONS[feature.slug]?.[activeLang] || {};
  
  // Merge deepDiveFeatures while preserving visualType
  const localizedDeepDive = (langOverrides.deepDiveFeatures || []).map((item, idx) => {
    const baseItem = feature.deepDiveFeatures?.[idx] || {};
    return {
      ...baseItem,
      ...item,
      visualType: item.visualType || baseItem.visualType
    };
  });
  ...
  return {
    ...
    moduleNumber: feature.moduleNumber,
    deepDiveFeatures: localizedDeepDive.length > 0 ? localizedDeepDive : feature.deepDiveFeatures
  };
}

export function getLocalizedAllFeatures(lang = "fr") {
  return ALL_FEATURES.map(f => getLocalizedFeature(f, lang));
}

export function getFeatureBySlug(slug, lang = "fr") {
  if (!slug) return null;
  const cleanSlug = slug.toLowerCase().trim();
  const found = ALL_FEATURES.find(
    f => f.slug === cleanSlug || (f.aliases && f.aliases.includes(cleanSlug))
  );
  if (!found) return null;
  return getLocalizedFeature(found, lang);
}
