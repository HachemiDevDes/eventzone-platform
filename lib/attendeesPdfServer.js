  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      const columns = [
        ...
        { key: "name", label: "Full Name", width: 122, align: "left" },
        { key: "email", label: "Email Address", width: 140, align: "left" },
        { key: "phone", label: "Phone", width: 80, align: "left" },
        { key: "company", label: "Company / Org", width: 110, align: "left" },
        { key: "jobTitle", label: "Job Title", width: 95, align: "left" },
        { key: "ticket", label: "Ticket / Role", width: 88, align: "left" },
        { key: "badgeCode", label: "Badge ID", width: 56, align: "center" },
      ...
      attendees.forEach((a, idx) => {
        ...
        const badgeCode = a.badgeCode || a.badge_code || `EZ-${String(a.id || "").slice(-4).toUpperCase()}`;
        ...
        columns.forEach((col) => {
          ...
          const isBadge = col.key === "badgeCode";
