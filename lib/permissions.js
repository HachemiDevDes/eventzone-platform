...
export function getEffectivePermissions(
  ...
  // 8. New Event / Demo Summit Context for Registered Organizers:
  const isUnassignedOrDemo = (!eventOrganizerIdStr && !eventContactEmail && !eventHostEmail && !eventOrganizerEmail) || 
    currentEventIdStr === "default-summit-2025" || 
    currentEventIdStr === "myevent" ||
    currentEventIdStr === "00000000-0000-0000-0000-000000000001";

  if ((!activeEvent && isOrganizerUser) || (isUnassignedOrDemo && isOrganizerUser)) {
    return {
      isOwner: true,
      isAdmin: true,
      isSimulated: false,
  ...
  // 9. Default fallback for non-team visitors / attendees: No organizer dashboard access
  return {
    isOwner: false,
    isAdmin: false,
    isSimulated: false,
