...
export default async function FeatureDetailPage({ params }) {
  ...
  return (
    <div className="min-h-screen w-full max-w-full overflow-x-clip flex flex-col relative bg-transparent text-slate-900 font-sans selection:bg-blue-600 selection:text-white">
