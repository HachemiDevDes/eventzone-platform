                            ...
                            {!isPending && onOpenAttendeePortal && (
                              isPortalClosed ? (
                                <button
                                  ...
                                  className="flex-1 py-2 px-3 bg-slate-100 hover:bg-slate-200 text-slate-600 rounded-xl text-[10px] font-bold border border-slate-200/90 transition-colors cursor-pointer flex items-center justify-center gap-1.5"
                                  title="Portal is currently closed by the organizer"
                                >
                                  <Lock size={11} className="text-slate-500 stroke-[2.2]" />
