...
import { 
  Check, Sparkles, Smartphone, Zap, MessageSquare, 
  CheckCheck, TrendingUp, Users, ShieldCheck, ArrowUpRight, 
  BarChart3, Lock, Copy 
} from "lucide-react";
...
function VisualGraphicCard({ item, idx, featureSlug, lang = "fr" }) {
  ...
  if (type === "social-funnel-preview") {
    return (
      <div className="space-y-4">
        {/* Mockup of Mobile In-App Browser Header */}
        <div className="p-3 rounded-2xl bg-slate-900 text-white shadow-md border border-slate-800">
          <div className="flex items-center justify-between text-[11px] text-slate-400 pb-2 border-b border-slate-800 font-mono">
            <div className="flex items-center gap-1.5">
              <span className="w-2 h-2 rounded-full bg-rose-500 animate-pulse" />
              <span className="text-slate-300 font-semibold">Instagram In-App Browser</span>
            </div>
            <span className="text-emerald-400 font-bold bg-emerald-950/80 px-2 py-0.5 rounded-full border border-emerald-500/30">
              ⚡ 0.74s load
            </span>
          </div>
          ...
          <div className="pt-2 flex items-center justify-between text-xs">
            <div className="flex items-center gap-1.5 text-slate-300">
              ...
              <span className="font-medium">eventzone.pro/algiers-tech</span>
            </div>
            <span className="text-[10px] bg-blue-600/30 text-blue-300 px-2 py-0.5 rounded-md font-mono">
              Guest Mode Active
            </span>
          </div>
        </div>

        {/* 1-Click Ticket Checkout Card */}
        <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-3">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-black text-slate-900">Pass VIP Conférence 2026</p>
              <p className="text-[11px] text-slate-500">Accès plénières + Networking Déjeuner</p>
            </div>
            <div className="text-right">
              <span className="text-base font-black text-blue-600">8 500 DZD</span>
              <span className="text-[10px] text-emerald-600 font-bold block">1 place réservée</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2 text-[11px]">
            <div className="p-2 rounded-lg bg-white border border-slate-200">
              <span className="text-slate-400 block text-[9px] uppercase font-bold">Nom Complet</span>
              <span className="font-semibold text-slate-800">Sarah B.</span>
            </div>
            <div className="p-2 rounded-lg bg-white border border-slate-200">
              <span className="text-slate-400 block text-[9px] uppercase font-bold">WhatsApp Mobile</span>
              <span className="font-semibold text-slate-800">+213 550 12 •• ••</span>
            </div>
          </div>

          {/* Instant 1-Click Pay */}
          <div className="p-3 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white flex items-center justify-between font-bold text-xs shadow-md shadow-emerald-600/20 cursor-default transition-all">
            <div className="flex items-center gap-2">
              <Zap size={14} className="fill-white" />
              <span>Confirmer sans mot de passe</span>
            </div>
            <span className="text-[10px] font-mono bg-emerald-800/60 px-2 py-0.5 rounded text-emerald-100">
              CIB / Edahabia
            </span>
          </div>
        </div>
        ...
        {/* Micro-metric Banner */}
        <div className="flex items-center justify-between px-2 pt-1 text-[11px] font-mono">
          <span className="text-slate-500">Taux de conversion mobile :</span>
          <span className="font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full border border-emerald-200">
            34.2% (+340% vs redirection)
          </span>
        </div>
      </div>
    );
  ...
  if (type === "whatsapp-recovery-preview") {
    return (
      <div className="space-y-4">
        {/* WhatsApp Chat Frame */}
        <div className="rounded-2xl border border-slate-200 shadow-lg overflow-hidden bg-[#EFEAE2]">
          ...
          <div className="bg-[#075E54] text-white p-3 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  <span className="text-xs font-bold leading-tight">Eventzone Concierge</span>
                  <span className="w-3.5 h-3.5 rounded-full bg-[#25D366] text-white flex items-center justify-center text-[9px]">
                    ✓
                  </span>
                </div>
                <span className="text-[10px] text-emerald-100 block">Compte Professionnel Vérifié</span>
              </div>
            </div>
            <span className="text-[10px] text-emerald-200 bg-emerald-900/40 px-2 py-0.5 rounded-full font-mono">
              Relance à T+15min
            </span>
          </div>
          ...
          <div className="p-3.5 space-y-3 text-xs">
            ...
            <div className="text-center">
              <span className="text-[9px] bg-white/70 text-slate-600 px-2.5 py-1 rounded-md shadow-2xs inline-block">
                🔒 Messages chiffrés de bout en bout
              </span>
            </div>

            {/* Inbound WhatsApp Message */}
            <div className="bg-white p-3 rounded-2xl rounded-tl-none shadow-xs max-w-[90%] space-y-2 text-slate-800">
              <p className="text-[11px] leading-relaxed">
                Bonjour Sarah 👋 Nous avons remarqué que vous n&apos;aviez pas finalisé votre place pour <strong>Algiers Tech Summit 2026</strong>.
              </p>
              <p className="text-[11px] leading-relaxed text-slate-600">
                Votre place VIP reste bloquée pendant <strong>28 minutes</strong>. Profitez de <strong>-10%</strong> avec le code <span className="font-mono font-bold text-emerald-700 bg-emerald-50 px-1 py-0.5 rounded border border-emerald-200">SOCIAL10</span> 🎟️
              </p>
            ...
            {/* Quick Action Buttons within WhatsApp */}
            <div className="space-y-1.5 pt-1">
              <div className="p-2.5 rounded-xl bg-white border border-emerald-300 text-[#075E54] font-bold text-xs flex items-center justify-center gap-2 shadow-xs hover:bg-emerald-50 cursor-default transition-colors">
                <CheckCheck size={14} className="text-[#25D366]" />
                <span>Finaliser ma réservation (-10%)</span>
              </div>
              <div className="p-2 rounded-xl bg-white/80 border border-slate-200 text-slate-600 text-xs flex items-center justify-center gap-1.5 hover:bg-white cursor-default">
                <MessageSquare size={12} className="text-slate-400" />
                <span>Poser une question à l&apos;organisateur</span>
              </div>
            </div>
          </div>
        ...
        {/* WhatsApp Performance Bar */}
        <div className="grid grid-cols-3 gap-2 text-center text-xs">
          <div className="p-2 rounded-xl bg-emerald-50 border border-emerald-200">
            <span className="text-[10px] text-emerald-700 font-bold block">Taux d&apos;ouverture</span>
            <span className="font-black text-emerald-900 font-mono">94.8%</span>
          </div>
          <div className="p-2 rounded-xl bg-blue-50 border border-blue-200">
            <span className="text-[10px] text-blue-700 font-bold block">Paniers Récupérés</span>
            <span className="font-black text-blue-900 font-mono">+42.5%</span>
          </div>
          <div className="p-2 rounded-xl bg-amber-50 border border-amber-200">
            <span className="text-[10px] text-amber-700 font-bold block">Temps Moyen</span>
            <span className="font-black text-amber-900 font-mono">&lt; 14 min</span>
          </div>
        </div>
      </div>
    );
  ...
  if (type === "influencer-attribution-preview") {
    return (
      <div className="space-y-3.5">
        {/* Top Header Card */}
        <div className="p-3.5 rounded-2xl bg-slate-900 text-white flex items-center justify-between">
          <div>
            ...
            <p className="text-xs font-bold text-slate-100">Attribution Créateurs & Conférenciers</p>
          </div>
          <span className="text-xs font-mono font-black text-[#00E575] bg-black/40 px-2.5 py-1 rounded-lg border border-[#00E575]/30">
            4.8x ROAS Moyen
          </span>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="p-3 rounded-xl bg-white border border-slate-200 shadow-2xs flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-amber-400 to-rose-500 text-white flex items-center justify-center font-bold text-xs shadow-xs">
                ST
              </div>
              <div>
                <div className="flex items-center gap-1.5">
                  <span className="text-xs font-bold text-slate-900">@sarah_tech</span>
                  <span className="text-[9px] bg-blue-100 text-blue-700 px-1.5 py-0.2 rounded font-semibold">Keynote</span>
                </div>
                <span className="text-[10px] text-slate-500 font-mono">Lien: ez.pro/summit?ref=sarah</span>
              </div>
            </div>
            <div className="text-right">
              <span className="text-xs font-black text-slate-900 block font-mono">342 billets</span>
              <span className="text-[10px] text-emerald-600 font-bold font-mono">24 600 € générés</span>
            </div>
          </div>
          ...
          <div className="p-3 rounded-xl bg-white border border-slate-200 shadow-2xs flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  <span className="text-xs font-bold text-slate-900">@algeria_design</span>
                  <span className="text-[9px] bg-purple-100 text-purple-700 px-1.5 py-0.2 rounded font-semibold">Média</span>
                </div>
                <span className="text-[10px] text-slate-500 font-mono">Lien: ez.pro/summit?ref=design</span>
              </div>
            </div>
            <div className="text-right">
              <span className="text-xs font-black text-slate-900 block font-mono">189 billets</span>
              <span className="text-[10px] text-emerald-600 font-bold font-mono">13 200 € générés</span>
            </div>
          </div>
          ...
          <div className="p-3 rounded-xl bg-white border border-slate-200 shadow-2xs flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-emerald-500 to-teal-600 text-white flex items-center justify-center font-bold text-xs shadow-xs">
                DZ
              </div>
              <div>
                <div className="flex items-center gap-1.5">
                  <span className="text-xs font-bold text-slate-900">@startup_dz</span>
                  <span className="text-[9px] bg-emerald-100 text-emerald-700 px-1.5 py-0.2 rounded font-semibold">Influenceur</span>
                </div>
                <span className="text-[10px] text-slate-500 font-mono">Lien: ez.pro/summit?ref=startup</span>
              </div>
            </div>
            <div className="text-right">
              <span className="text-xs font-black text-slate-900 block font-mono">145 billets</span>
              <span className="text-[10px] text-emerald-600 font-bold font-mono">10 150 € générés</span>
            </div>
          </div>
        </div>

        {/* Quick Link Generator Bar */}
        <div className="p-2.5 rounded-xl bg-slate-100 border border-slate-200 flex items-center justify-between text-xs">
          <span className="text-slate-600 text-[11px] font-medium">Générer un lien affilié instantané :</span>
          <span className="text-blue-600 font-bold font-mono text-[11px] bg-white px-2 py-0.5 rounded border border-slate-200">
            1-Clic Nouveau Lien + Code Promo
          </span>
        </div>
      </div>
    );
  ...
  if (type === "conversion-analytics-preview") {
    return (
      <div className="space-y-4">
        {/* Tracking Badges Bar */}
        <div className="flex flex-wrap items-center gap-2 text-[11px]">
          <span className="px-2.5 py-1 rounded-lg bg-emerald-50 border border-emerald-200 text-emerald-800 font-bold flex items-center gap-1">
            <span className="w-2 h-2 rounded-full bg-emerald-500" />
            Meta CAPI Server-Side (100% Match)
          </span>
          <span className="px-2.5 py-1 rounded-lg bg-blue-50 border border-blue-200 text-blue-800 font-bold flex items-center gap-1">
            <span className="w-2 h-2 rounded-full bg-blue-500" />
            TikTok Pixel
          </span>
          <span className="px-2.5 py-1 rounded-lg bg-amber-50 border border-amber-200 text-amber-800 font-bold flex items-center gap-1">
            <span className="w-2 h-2 rounded-full bg-amber-500" />
            Google Tag Manager
          </span>
        </div>

        {/* Channels ROAS Breakdown */}
        <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-3.5">
          
          {/* Instagram Ads */}
          <div>
            <div className="flex items-center justify-between text-xs font-semibold mb-1">
              <span className="text-slate-800">Instagram Ads (Stories & Reels)</span>
              <span className="text-emerald-600 font-bold font-mono">4.2x ROAS • 480 inscrits</span>
            </div>
          ...
          <div>
            <div className="flex items-center justify-between text-xs font-semibold mb-1">
              <span className="text-slate-800">TikTok Organic & Boosted</span>
              <span className="text-emerald-600 font-bold font-mono">5.8x ROAS • 320 inscrits</span>
            </div>
            <div className="h-2 w-full bg-slate-200 rounded-full overflow-hidden">
              <div className="h-full bg-slate-900 rounded-full" style={{ width: "28%" }} />
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between text-xs font-semibold mb-1">
              <span className="text-slate-800">LinkedIn InMail & Posts Partenaires</span>
              <span className="text-emerald-600 font-bold font-mono">3.6x ROAS • 205 inscrits</span>
            </div>
            <div className="h-2 w-full bg-slate-200 rounded-full overflow-hidden">
          ...
          <div>
            <div className="flex items-center justify-between text-xs font-semibold mb-1">
              <span className="text-slate-800">WhatsApp Direct & Relances</span>
              <span className="text-emerald-600 font-bold font-mono">8.4x ROAS • 140 inscrits</span>
            </div>
            <div className="h-2 w-full bg-slate-200 rounded-full overflow-hidden">
              <div className="h-full bg-[#25D366] rounded-full" style={{ width: "12%" }} />
            </div>
          </div>

        </div>

        {/* Signal Integrity Callout */}
        <div className="p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-900 flex items-center justify-between text-xs">
          <span className="font-semibold">Résilience iOS 14+ / AdBlockers :</span>
          <span className="font-bold font-mono text-emerald-700">0% de perte de signal</span>
        </div>
      </div>
    );
  }
